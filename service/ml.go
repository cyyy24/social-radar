...
// This module is for use with our Google ML model. It is responsible for sending a request to
// Google ML Predict API with our image and get the score back from the model.
